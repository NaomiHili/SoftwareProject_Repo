...
?>
   ...
   <?php
    ...
    $result3 = mysqli_query($conn, $query3) or die ("Error in query". mysqli_error($conn)); // doctor table result
    
    $result4 = mysqli_query($conn, $query4) or die ("Error in query". mysqli_error($conn)); // appointment table result
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <select id="yourDoctor" name="ourDoctors" class="form-control">
                                 <?php
                                  ...
                                  {
                                    echo "<option value=".$row3['Doctor_Id'].">". $row3['Name']."</option>";
                                  }
                                ?>
                              </select>
                          <div class="modal-footer">
